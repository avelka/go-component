  ...
  render() {
    ...
    return (
      <svg
        ...
        <defs>
          <filter id="wood_texture" x="-20%" y="-20%" width="140%" height="140%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse" color-interpolation-filters="s-rGB">
    ...
    return (
      <g>
        <symbol id={`marker_circle_onempty`} width={size} height={size} viewBox="0 0 20 20">
          <circle cx="10" cy="10" r="6" fill="none" stroke="#000" opacity="0.7" />
        </symbol>
        <symbol id={`marker_triangle_onempty`} width={size} height={size} viewBox="0 0 20 20">
          <polygon points="10,5 5,15 15,15" fill="transparent" stroke="#000" opacity="0.7" />
        </symbol>
        <symbol id={`marker_square_onempty`} width={size} height={size} viewBox="0 0 20 20">
          <rect x="5" y="5" width="10" height="10" fill="transparent" stroke="#000" opacity="0.7" />
        </symbol>
        <symbol id={`marker_mark_onempty`} width={size} height={size} viewBox="0 0 20 20">
          <path d="M 5 5 L 15 15 M 5 15 L 15 5" fill="transparent" stroke="#000" opacity="0.7" />
        </symbol>

        <symbol id={`marker_circle_onblack`} width={size} height={size} viewBox="0 0 20 20">
          <circle cx="10" cy="10" r="6" fill="none" stroke="#fff" opacity="0.7" />
        </symbol>
        <symbol id={`marker_triangle_onblack`} width={size} height={size} viewBox="0 0 20 20">
          <polygon points="10,5 5,15 15,15" fill="transparent" stroke="#fff" opacity="0.7" />
        </symbol>
        <symbol id={`marker_square_onblack`} width={size} height={size} viewBox="0 0 20 20">
          <rect x="5" y="5" width="10" height="10" fill="transparent" stroke="#fff" opacity="0.7" />
        </symbol>
        <symbol id={`marker_mark_onblack`} width={size} height={size} viewBox="0 0 20 20">
          <path d="M 5 5 L 15 15 M 5 15 L 15 5" fill="transparent" stroke="#fff" opacity="0.7" />
        </symbol>
